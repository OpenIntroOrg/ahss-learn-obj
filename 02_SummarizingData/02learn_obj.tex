...
\item Use back-to-back stem-and-leaf plots, side-by-side box plots, or pairs of dot plots/histograms for comparing the distribution of a numerical variable across multiple groups (eg, male/female).  
\end{enumerate}
